...
// Gemini spec mentions TLS v1.2 as minimum, TLS v1.3 as desired.
const MIN_TLS_VERSION = 'TLSv1.2'

async function doGeminiRequest(event, url) {
  const parsedUrl = parseUrl(url)
  let connectionTimeoutMs = 20 * 1000
  let tlsOpt = { rejectUnauthorized: false }
  let cert = null
  let key = null
  let passphrase = null
...
module.exports = doGeminiRequest
